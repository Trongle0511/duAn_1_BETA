...
//            }else{
    ...
    void update(){
        if(check()){
//            if(!Auth.isManager()){
//                MsgBox.alert(this, "Chỉ có quản lí mới có quyền sửa thông tin nhân viên!!!");
//            }else{
                NhanVien nv = getForm();
                try {
...
//        if(check()){
//            if(!Auth.isManager()){
//                MsgBox.alert(this, "Chỉ có quản lý mới có quyền xóa thông tin nhân viên");
//            }else{
                String maNV = txtMaNV.getText();
//                if(maNV.equals(Auth.user.getMaNV())){
//                    MsgBox.alert(this, "Bạn không thể xóa chính mình");
//                }else{
                    MsgBox.confirm(this, "Bạn có muốn xóa nhân viên này?");
        ...
        try {
            ...
            List<NhanVien> list = new NhanVienDAO().selectByKeyword(keyword);
            for (NhanVien nv : list) {
                    if (nv != null) {
                        Object[] row = {
                        nv.getMaNV(),
